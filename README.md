...
(move into the directory where global is located and [sudo chmod +x global] {if you want to do it for all users}, then [cp global global0] and start global0 to install global) ^^
